 ...
 * Quantumult X
 * [rewrite_local]
 * ^https?:\/\/biz\.cyapi\.cn\/(membership_rights|v2\/user) url script-response-body caiyun_svip.js
 *
 * Surge or Loon
 * [Script]
 *http-response ^https?:\/\/biz\.cyapi\.cn\/(membership_rights|v2\/user) requires-body=1,max-size=0,script-path=caiyun_svip.js
 * 
 */
